  ...
  (walk/postwalk (fn [x]
                   (if (seq? x)
                     (case (first x)
                       ...
                       fn (list 'clojure.core/unquote (list 'clojure.core/fn [] (cons 'firelisp.core/fn (rest x))))
                       fn* (list 'clojure.core/unquote (list 'clojure.core/fn [] (cons 'firelisp.core/fn (rest x))))
                       macro (list 'clojure.core/unquote (list 'clojure.core/fn [] (cons 'firelisp.core/macro (rest x))))
